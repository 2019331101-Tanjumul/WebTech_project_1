            ...
            <div class="flex flex-1 items-center justify-center">
                <div class="rounded-xl sm:border-2 px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center shadow-xl">
                    ...
                    <div class="text-center mt-12">
                        ...
                        <a href="signup" class="font-light text-md text-purple-600 underline font-semibold hover:text-purple-800">Create One</a>
                    </div>
                </div>
            </div>
        </div>
        <div> <!-- for footer -->
            <footer class="mt-36 w-full bg-white shadow-lg">
                <div class="text-center">
